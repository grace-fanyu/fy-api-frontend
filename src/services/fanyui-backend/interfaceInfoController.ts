...
/** buyInterfaceInfo POST /api/interfaceInfo/buy */
export async function buyInterfaceInfoUsingPOST(
  body: API.InterfaceInfoBuyRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseboolean>('/api/interfaceInfo/buy', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listInterfaceInfoByPageUsingGET(
  ...
  return request<API.BaseResponseListInterfaceInfoVO>('/api/interfaceInfo/list/page', {
    method: 'GET',
    params: {
      ...params,
    },
